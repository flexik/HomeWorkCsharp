...
int DifferenceBetweenMaxMin(int[] array){        // метод возвращающий разницу между минимальным и максимальным значениями массива
    int MinValue = 0;
    int MaxValue = 0; 
...
Console.WriteLine($"Разница между максимальным значением и минимальным: {DifferenceBetweenMaxMin(Array)}");